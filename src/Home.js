  ...
  return (
    <div className="home">
      ...
      <div class="home__row">
        <Product
          id="12321341"
          title="The Lean Startup: How Constant Cnnovation Creates Radically Successful Businesses Paperback"
          price={11.96}
          rating={5}
        ...
        <Product
          ...
          Mixer with K-beater, Dough Hook and Whisk, 5 Litre Glass Bow"
          price={239.0}
          rating={4}
      ...
      <div class="home__row">
        <Product
          id="4903850"
          title="Samsung LC49RG90SSIXEM 49' Curved LED Gaming Monitor"
          price={199.0}
          rating={3}
      ...
      <div class="home__row">
        <Product
          id="90829332"
          title="Samsung LC49RG90SSUXEN 49' Curved LED Gaming 
          Monitor - Super Ultra Wide Dual WQHD 5120 x 1440"
          price={1094.98}
          rating={4}
